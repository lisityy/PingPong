...
SOURCES += font_prop14x16.c font_rom8x16.c drawing.c pages.c utils.c game.c game_objects.c checker_game.c draw_game.c games_effects.c
TARGET_EXE = main
TARGET_IP ?= 192.168.223.131
ifeq ($(TARGET_IP),)
ifneq ($(filter debug run,$(MAKECMDGOALS)),)
$(warning The target IP address is not set)
$(warning Run as "TARGET_IP=192.168.223.118 make run" or modify Makefile)
